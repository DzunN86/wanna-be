...
import {pxToLetterSpacing, pxToLineHeight, pxToFontSize} from './conversionTables';
...
export class TailwindTextBuilder extends TailwindDefaultBuilder {
    constructor(node: AltTextNode, showLayerName: boolean, optIsJSX: boolean, generateSingle: boolean) {
        super(node, showLayerName, optIsJSX, generateSingle);
    }
